export const trackStory: { [char: string]: string } = {
  one: "Madjedbebe on the South Alligator floodplain at Kakadu: The site of the oldest verified human occupation in Australia, 64,000 years, which I visited recently. And it also happens to be on the Jabiluka mining lease which is trenchantly opposed by traditional owners, and must not be renewed.",
